...
const songs = [
    ...
    {
        id: '4',
        songName: `We Belong Together <br>
        <div class="subtitle">Mariah Carey</div>`,
        poster: "img/4.jpg"
    },
    {
        id: '5',
        songName: `Codeine Crazy <br>
        <div class="subtitle">Future</div>`,
        poster: "img/5.jpg"
    },
    {
        id: '6',
        songName: `Flashing Lights <br>
    ...
    {
        id: '13',
        songName: `Empire State of Mind <br>
        <div class="subtitle">Jay-Z</div>`,
        poster: "img/13.jpg"
    },
...
music.addEventListener('timeupdate', ()=>{
    ...
    let min1 = Math.floor(music.currentTime/60);
    let sec1 = Math.floor(music.currentTime/60);
    if(sec1<10){
        sec1 = `0${sec1}`
    }
...
let right_scroll = document.getElementById('left_scroll');